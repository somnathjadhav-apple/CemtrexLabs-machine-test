...
class DBManager {
    ...
    //MARK: Insert Into DB
    func insert(venueObj: venueDetails) {
        let venues = read()
        for venue in venues {
    ...
    func readVenue(venueObject: venueDetails) -> [venueDetails] {
    ...
    //MARK: Delete from DB
    func deleteByID(venueObject: venueDetails) {
